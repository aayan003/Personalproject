...
with st.sidebar:
    ...
    st.write("NB! Please relaod the website after you have asked a question on a topic, and youre moving onto a different topic. There is a limitation where it does not take in more information than one link, so it will answer kinda incorrectly of yout don't")
    website_urls = (
